...
public class ClientEventNotCancelableBecauseDateException extends Exception{
    private Long eventId;
    private LocalDateTime celebrationDate;

    public ClientEventNotCancelableBecauseDateException(Long eventId, LocalDateTime celebrationDate) {
